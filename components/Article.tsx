      ...
      {!loading ? (
        ...
        >
          {mockArticles.map((article, index) => (
            <article
              key={index}
              className="flex flex-col bg-slate-100 rounded-xl h-full
            ...
            >
              ...
              <div className="flex-1 flex flex-col p-4 justify-between">
                <h2
                  className="font-semibold mb-2 text-lg max-sm:text-sm
                font-custom"
                >
              ...
              <Link
                ...
                className="h-10 rounded-b-lg text-center bg-gradient-to-r
                   from-primary to-primary_light text-white 
